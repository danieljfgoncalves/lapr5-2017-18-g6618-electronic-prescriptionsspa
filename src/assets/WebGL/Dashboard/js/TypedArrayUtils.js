 ...
 THREE.TypedArrayUtils.Kdtree = function ( points, metric, eleSize ) {
	...
	this.nearest = function ( point, maxNodes, maxDistance ) {
		 ...
		 /* point: array of size eleSize
			...
			maxDistance: maximum distance to point medicinesMap nodes should have
			condition (not implemented): function to test node before it's added to the medicinesMap list, e.g. test for view frustum
		*/
